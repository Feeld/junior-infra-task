...
Reliability:
  New Relics customer base is over ~1700 
  Customer's data is stored in a Tier III, SSAE-16 certified centers and regulary backed up.
  The offered products are tested and if one encounters issues there is [support](https://docs.newrelic.com/docs/licenses/license-information/general-usage-licenses/global-technical-support-offerings) available depending on subscruption level. In addition to the support service, there is a [community service](https://discuss.newrelic.com) and [gsource projects](https://github.com/newrelic).
